...
/**
 * جداول يملكها الإطار: الجلسات والكاش والطوابير.
 *
 * مفصولة عن جداول الكونسول عمدًا. تلك مطابقة حرفيًا للنظام القديم ولا تُلمس،
 * وهذه إضافات جديدة لا يقرأها النظام القديم ولا يكتبها — فوجودها لا يؤثر على
 * تشغيل النسختين جنبًا إلى جنب أثناء الترحيل.
 *
 * الجلسات في قاعدة البيانات لا في الملفات: وضع SaaS قد يعمل على أكثر من خادم
 * تطبيق، وجلسة على قرص خادم واحد تعني خروج المستخدم عشوائيًا بين الطلبات.
 */
