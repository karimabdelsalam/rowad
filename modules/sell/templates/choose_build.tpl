    ...
    <div class="widget-body innerAll">
      <div class="row innerAll inner-2x">
        <div class="col-md-offset-2 col-md-4">
          <div class="widget">
            ...
            <div class="text-center innerAll">
              <span class="strong">{"ابحث في العقارات المتاحة للبيع"|gettext}</span>
            </div>
          </div>
        ...
        <div class="col-md-offset-1 col-md-4">
          <div class="widget">
            <div class="display-block innerAll text-center"><i class="fa fa-plus-circle" style="font-size:185px"></i></div>
            <div class="text-center innerAll">
