<div class="filter-bar">
  <form action="" method="get" class="form-horizontal innerAll">
    <div class="form-group">
      <label class="col-md-2">{"اسم المستند"|gettext}</label>
      <div class="col-md-3">
      ...
      <table class="table table-condensed table-striped table-primary table-vertical-center checkboxs">
        <thead>
          <tr>
            ...
            <th class="center">{"تاريخ الإنتهاء"|gettext}</th>
            <th class="center">{"التنبيهات"|gettext}</th>
        ...
        <tbody>
          {foreach from=$results item=result}
            <tr class="selectable">
              ...
              <td class="center">{if $result.notify eq 1}<span class="label label-success"><i class="fa fa-check-circle"></i></span>{else}<span class="label label-default"><i class="fa fa-close"></i></span>{/if}</td>
