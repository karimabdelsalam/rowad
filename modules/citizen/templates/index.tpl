<div class="filter-bar">
  <form action="" method="get" class="form-horizontal innerAll">
    ...
    <div class="form-group">
      <label class="col-md-2">{"رقم الهوية"|gettext}</label>
      <div class="col-md-3">
        <input type="text" name="idnumber" value="{$smarty.get.idnumber}" class="form-control" />
      </div>
    </div>
        ...
        <tbody>
          {foreach from=$results item=result}
            <tr class="selectable">
              ...
              <td class="center"><span class="label label-primary">{$result.idnumber}</span></td>
              <td class="center"><span class="label label-danger">{$result.national}</span></td>
