<form action="" class="form-horizontal margin-none form-ajax" method="post">
  ...
  <input type="hidden" name="paymentids" value="{$smarty.get.payid}" />
  <input type="hidden" name="paymentid" value="{$smarty.get.payid}" />
  <div class="widget">
    ...
    <div class="widget-body innerAll">
      <div class="row innerLR">
        <div class="col-md-12">
          <div class="form-group">
            <label class="col-md-2 control-label">{"تاريخ الاستلام"|gettext}</label>
            <div class="col-md-3">
            ...
            <div class="col-md-3">
              <select name="calendar" class="form-control calendarAutoChange" required>
                ...
                <option value="2" {if $data.calendar eq 2 OR (empty($data.calendar) AND $config.credit_calendar eq 2)}selected="selected"{/if}>{"هجري"|gettext}</option>
              </select>
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <label class="col-md-2 control-label">{"يضاف الى"|gettext} {"اضافة المبلغ الى رصيد الحساب البنكي"|gettext|help}</label>
            <div class="col-md-6">
          ...
          <div class="form-group no-border-space">
            <label class="col-md-2 control-label">{"استلمنا من"|gettext}</label>
            <div class="col-md-3">
          ...
          <div class="form-group StatementFromType_owner">
            ...
            <div class="col-md-6">
              <select class="full-width" name="ownerid[]" multiple required>
          ...
          <div class="form-group">
            <label class="col-md-2 control-label">{"نوع الإيراد"|gettext}</label>
            <div class="col-md-4">
      ...
      <div class="row innerLR StatementPayMethod_bank">
        <div class="col-md-6">
          ...
          <div class="form-group">
            <label class="col-md-4 control-label">{"رقم الحساب المحول إليه"|gettext}</label>
            <div class="col-md-7">
              <select class="form-control" name="bank[tobankid]" required>
                {foreach $bankaccounts as $bankaccount}
                <option value="{$bankaccount.id}" {if $data.bank.tobankid eq $bankaccount.id}selected="selected"{/if}>{$bankaccount.bank}: {$bankaccount.fullname}</option>
                {/foreach}
              </select>
            </div>
          </div>
          <div class="form-group">
            <label class="col-md-4 control-label">{"اسم الحساب المحول منه"|gettext}</label>
            <div class="col-md-7">
              <input class="form-control" name="bank[fromname]" value="{$data.bank.fromname|clean}" type="text" required />
            </div>
          </div>
          <div class="form-group">
        ...
        <div class="col-md-6">
          ...
          <div class="form-group">
            <label class="col-md-4 control-label">{"اسم البنك المحول منه"|gettext}</label>
            <div class="col-md-4">
              <select class="form-control" name="bank[frombankid]" required>
                {foreach $banks as $bank}
                <option value="{$bank.id}" {if $data.bank.frombankid eq $bank.id}selected="selected"{/if}>{$bank.title|clean}</option>
                {/foreach}
              </select>
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-md-7">
              <input class="form-control" name="bank[fromno]" value="{$data.bank.fromno|clean}" type="text" required />
            </div>
          </div>
        </div>
      </div>
