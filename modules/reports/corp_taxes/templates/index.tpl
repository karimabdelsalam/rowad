      ...
      <table class="table table-condensed table-striped table-primary table-vertical-center checkboxs">
        <thead>
          <tr>
            ...
            <th class="center">{"الضريبة"|gettext}</th>
            <th class="center">{"رقم السند"|gettext}</th>
            <th class="center">{"التاريخ"|gettext}</th>
            <th class="center">{"النوع"|gettext}</th>
            <th class="center">{"تفاصيل الدفعة"|gettext}</th>
            <th class="center">{"عقار"|gettext}</th>
        ...
        <tbody>
          {foreach name=op from=$results item=result}
            <tr class="selectable">
              ...
              <td class="center"><span class="label label-success">{$result.gone_date|ardate:false:false}</span></td>
              <td class="center"><span class="label label-default">{$result.transtype|gettext|clean}</span></td>
              <td class="center"><span class="label label-primary">{$result.paytype|gettext|clean}</span></td>
