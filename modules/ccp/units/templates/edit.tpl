  ...
  <div class="widget">
    ...
    <div class="widget-body innerAll">
            ...
            <div class="col-md-6">
              <select name="locid" class="ajaxSelect" style="height: 34px;width:80%">
                  ...
                  {foreach $locations as $location}
                    <option value="{$location.id}" {if $data.locid eq $location.id}selected="selected"{/if}>{$location.location}</option>
                  {/foreach}
              </select>
              <a href="{$CPURL}/building/locations/add" class="btn btn-default pull-left quick-form"><i class="fa fa-plus-circle"></i></a>
            </div>
          </div>
        </div>
        <div class="col-md-6">
      ...
      <div class="row innerLR">
        <div class="col-md-6">
          <div class="form-group">
            <label class="col-md-3 control-label">{"اسم العقار"|gettext} {"اسم العقار في حالة انه عقار رئيسي او اسم الفئة/الوحدة في حالة انها داخل عقار رئيسي"|gettext|help}</label>
            <div class="col-md-7">
          ...
          <div class="row innerAll">
            <div class="col-md-12 ownerAjaxHolder">
              <div class="form-group hang-form">
                ...
                <div class="col-md-8">
                  <select class="ownerAjaxSearch noSelect2" style="height: 34px;width:60%">
                  </select>
