<div class="filter-bar">
  <form action="" method="get" class="form-horizontal innerAll">
    ...
    <div class="form-group hide2">
      <label class="col-md-2">{"بريد إليكتروني"|gettext}</label>
      <div class="col-md-3">
      ...
      <table class="table table-condensed table-striped table-primary table-vertical-center checkboxs">
        <thead>
          <tr>
            ...
            <th class="center">{"عدد العقارات"|gettext}</th>
        ...
        <tbody>
          {foreach from=$results item=result}
            <tr class="selectable">
              ...
              <td class="center"><span class="label label-warning">{$result.buildsCount}</span></td>
