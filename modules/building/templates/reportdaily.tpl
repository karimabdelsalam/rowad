<table>
  <tr>
    <th colspan="50" class="center" style="font-size: 22px;background-color: #fed54d">{"تقرير"|gettext} {"شهر"|gettext} {$smarty.now|date_format:"%I/%Y"}</th>
  </tr>
  <tr>
  ...
  <tr>
    ...
    {foreach from=$results item=result}
      <tr>
        <td>{$result.m_location} {$result.title}</td>
