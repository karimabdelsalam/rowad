      ...
      <table class="table table-condensed table-striped table-primary table-vertical-center checkboxs">
        <thead>
          <tr>
            ...
            <th class="center">{"النص الملحق"|gettext}</th>
            <th class="center">{"إلزامية"|gettext}</th>
        ...
        <tbody>
          {foreach from=$results item=result}
            <tr class="selectable">
              ...
              <td class="center"><span class="label label-primary">{if $result.type eq "checkbox"}{"مربع اختياري"|gettext}{else}{"نصية"|gettext}{/if}</span></td>
              <td class="center"><span class="label label-warning">{$result.suffix}</span></td>
              <td class="center"><span class="label label-default">{if $result.required eq 1}{"اختيارية"|gettext}{else}{"الزامية"|gettext}{/if}</span></td>
